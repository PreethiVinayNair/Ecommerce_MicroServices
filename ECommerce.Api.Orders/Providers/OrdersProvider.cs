      ...
      if (!dbContext.Orders.Any())
      {
        ...
        dbContext.Orders.Add(new Order()
        {
          ...
          Items = new List<Db.OrderItem>()
                    {
                        new Db.OrderItem() { OrderId = 4, ProductId = 1, Quantity = 10, UnitPrice = 10 },
                        new Db.OrderItem() { OrderId = 5, ProductId = 2, Quantity = 10, UnitPrice = 10 },
                        new Db.OrderItem() { OrderId = 6, ProductId = 3, Quantity = 1, UnitPrice = 100 }
                    },
          Total = 100
        });
        dbContext.Orders.Add(new Order()
          ...
          Items = new List<Db.OrderItem>()
                    {
                        ...
                        new OrderItem() { OrderId = 8, ProductId = 2, Quantity = 10, UnitPrice = 10 },
                        new OrderItem() { OrderId = 9, ProductId = 3, Quantity = 1, UnitPrice = 100 }
                    },
          Total = 100
        });
