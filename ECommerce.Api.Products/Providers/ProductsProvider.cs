  ...
  public class ProductsProvider : IProductsProvider
  {
    ...
    private void SeedData()
    {
      if(!dbContext.Products.Any())
      {
        ...
        dbContext.Products.Add(new Db.Product() { Id = 2, Name = "Mouse", Price = 20, Inventory = 10 });
        dbContext.Products.Add(new Db.Product() { Id = 3, Name = "Monitor", Price = 300, Inventory = 1000 });
